#'
#' depictSlot
#' @name depictSlot-Ready4Module
#' @description depictSlot method applied to Ready4Module
...
#' @aliases depictSlot,Ready4Module-method
#' @export
methods::setMethod("depictSlot", "Ready4Module", function (x,
                                                                 slot_nm_1L_chr,
                                                                 ...){
